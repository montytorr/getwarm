    ...
    render: function() {
        return (
            React.createElement("div", null, 
                React.createElement("div", {className: "head-component"}, 
                    React.createElement("div", {className: "head-home-button"}, 
                        React.createElement("h3", null, "WARM")
                    ), 
                    React.createElement("div", {className: "head-anchor-list"}, 
                        React.createElement("ul", null, 
                            React.createElement("li", null, React.createElement("a", {href: "#about"}, "About")), 
                            React.createElement("li", null, React.createElement("a", {href: "#discover"}, "Discover"))
                        )
                    )
                ), 
                React.createElement("div", {className: "download-component"}, 
                    React.createElement("div", {className: "download-container"}, 
                        React.createElement("h1", null, "WARM"), 
                        React.createElement("h3", null, "- We Are React Masters -"), 
                        React.createElement("button", {className: "download-button"}, "Be WARM")
                    )
                ), 
                React.createElement("div", {id: "about", className: "about-component"}, 
                    React.createElement("div", {className: "about-container"}, 
                        React.createElement("h2", null, "' What is WARM? '"), 
                        React.createElement("br", null), 
                        React.createElement("div", {className: "about-paragraph"}, 
                            React.createElement("p", null, "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna ali Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat."), 
                            React.createElement("br", null), 
                            React.createElement("p", null, "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur."), 
                            React.createElement("br", null), 
                            React.createElement("p", null, "Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.")
                        )
                    )
                ), 
                React.createElement("div", {id: "discover", className: "discover-component"}, 
                    React.createElement("div", {className: "discover-container"}, 
                        React.createElement("h2", null, "' Discover WARM '"), 
                        React.createElement("div", {className: "discover-box"}
...
React.render(
    React.createElement(WarmApp, null),
    document.getElementById('app-view')
);


},{"./app/app.jsx":157,"react":156}]},{},[158]);
